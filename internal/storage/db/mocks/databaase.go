...
//
//	mockgen -source ./database.go -destination=./mocks/databaase.go -package=mock_database
//
...
func (m *MockPGX) BeginTx(ctx context.Context, options *v4.TxOptions) error {
	m.ctrl.T.Helper()
...
func (mr *MockPGXMockRecorder) BeginTx(ctx, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BeginTx", reflect.TypeOf((*MockPGX)(nil).BeginTx), ctx, options)
}

// Exec mocks base method.
func (m *MockPGX) Exec(ctx context.Context, query string, args ...any) (pgconn.CommandTag, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPGXMockRecorder) Exec(ctx, query any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockPGX) ExecQueryRow(ctx context.Context, query string, args ...any) v4.Row {
	m.ctrl.T.Helper()
	varargs := []any{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockPGXMockRecorder) ExecQueryRow(ctx, query any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, query}, args...)
...
func (m *MockPGX) Get(ctx context.Context, dest any, query string, args ...any) error {
	m.ctrl.T.Helper()
...
func (mr *MockPGXMockRecorder) Get(ctx, dest, query any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPGXMockRecorder) GetPool(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPool", reflect.TypeOf((*MockPGX)(nil).GetPool), arg0)
}

// Select mocks base method.
func (m *MockPGX) Select(ctx context.Context, dest any, query string, args ...any) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, dest, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockPGXMockRecorder) Select(ctx, dest, query any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, dest, query}, args...)
